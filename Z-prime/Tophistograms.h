...
void TopAnalysis::define_histograms()
{
  // HISTOGRAMS
  // Global histograms
  hist_vismass      = new TH1F("hist_vismass",     "Visible Mass; M^{vis}_{ll};Events", 20, 0, 400);
  hist_etmiss       = new TH1F("hist_etmiss",      "Missing Transverse Momentum; E_{T,Miss} [GeV]; Events", 20, 0,400);
  ...
  hist_mt           = new TH1F("hist_mt",          "Transverse Mass; mT(W);Events", 20, 0, 400);
  // Jet variables histograms
  hist_n_jets       = new TH1F("hist_n_jets",      "Number of Jets; N_{jets} ;Events", 10, 0, 10);
  ...
  hist_n_bjets       = new TH1F("hist_n_bjets",      "Number of b-Jets; N_{b-jets} ;Events", 5, 0, 5);
  ...
  hist_Topmass = new TH1F("hist_Topmass","Top Invariant Mass; M_{Top};Events", 20, 0, 1500);
  hist_Wmass = new TH1F("hist_Wmass","W Invariant Mass; M_{W};Events", 20, 0, 1500);
  hist_mazz = new TH1F("hist_mazz","Z' Invariant Mass; M_{Z'};Events", 20, 0, 1500);
}
