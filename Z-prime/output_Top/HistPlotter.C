...
//std::string histname = "hist_leadjet_pt"; // DONT WORK
//std::string histname = "hist_leadjet_eta"; // DONT WORK
//std::string histname = "hist_leadjet_jvf"; // DONT WORK
//std::string histname = "hist_leadjet_MV1"; // DONT WORK
//std::string histname = "hist_n_bjets";
...
void HistPlotter(){
  ...
  h_signal->Scale(1e2*lumi*signalmap[("ZPrime" + signalmass).c_str()]);
...
////////////////////////////
  ...
  if(logy) can->SaveAs(("final-distribution-plots/"+outfile+"_log.pdf").c_str());
  else can->SaveAs(("final-distribution-plots"+outfile+".pdf").c_str());
}
