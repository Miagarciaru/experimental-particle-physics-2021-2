                    ...
                    if(jet_n >= 4)
                    {
                        ...
                        for(unsigned int i=0; i<jet_n; i++){
                            if(jet_pt[i]>25000. && TMath::Abs(jet_eta[i])<2.5){
                                // JVF cleaning
                                if(jet_pt[i]<50000.){
                                    if(TMath::Abs(jet_eta[i])>=2.4 || jet_jvf[i]<=0.5){
                                        continue;
                                    }
                                }
                                ...
                                if(met_et > 30000.){  
                                    if(Lepton1_MeT_MT > 30000.){
                                        ...
                                        */
                                        ...
                                        j3.SetPtEtaPhiE(jet_pt[goodjet_index[thjet]], jet_eta[goodjet_index[thjet]], jet_phi[goodjet_index[thjet]], jet_E[goodjet_index[thjet]]);
                                        j4.SetPtEtaPhiE(jet_pt[goodjet_index[fojet]], jet_eta[goodjet_index[fojet]], jet_phi[goodjet_index[fojet]], jet_E[goodjet_index[fojet]]);

                                        float mazz = (j1 + j2 + j3 + j4 + Lepton_1 + MeT).M()/1000.;
                                        //hist_mazz->Fill(mazz, weight);
                    
                                        double names_of_global_variable[]={InvMass1_inGeV, missingEt,
                                                                           Lepton1_MeT_MT/1000., hardest3mass,
                                                                           hardest2mass, mazz};
                                        
                                        double names_of_leadlep_variable[]={Lepton_1.Pt()/1000., Lepton_1.Eta(), 
                                                                            Lepton_1.E()/1000., Lepton_1.Phi(),
                                                                            lep_ptcone30[goodlep_index],
                                                                            lep_etcone20[goodlep_index]};
                                        
                                        double names_of_jet_variable[]={(double)jet_n, jet_pt[0]/1000., 
                                                                        jet_eta[0], jet_m[0]/1000., 
                                                                        jet_jvf[0], jet_MV1[0], 
                                                                        (double)goodbjet_n};

                                        TString histonames_of_global_variable[]={"hist_vismass","hist_etmiss",
                                                                                 "hist_mt","hist_Topmass",
                                                                                 "hist_Wmass","hist_mazz"};
                                        
                                        TString histonames_of_leadlep_variable[]={"hist_leadleptpt", "hist_leadlepteta",
                                                                                  "hist_leadleptE","hist_leadleptphi",
                                                                                  "hist_leadlept_ptc","hist_leadleptetc"};
                                        
                                        TString histonames_of_jet_variable[]={"hist_n_jets","hist_leadjet_pt",
                                                                              "hist_leadjet_eta","hist_leadjet_m",
                                                                              "hist_leadjet_jvf", "hist_leadjet_MV1",
                                                                              "hist_n_bjets"};
